...
import { Story, Appearance, Video, GeneralSettings } from '@/types/vidlytics';
...
const WidgetPreview: React.FC<WidgetPreviewProps> = ({
  ...
  useEffect(() => {
    const buildStoryVideoMap = async () => {
      ...
      try {
        if (storeId) {
          allStoryVideos = await VidlyticsDatabaseService.getStoryVideos(storeId);
        }
      } catch (e) {
        console.error('Erro ao buscar story videos no preview:', e);
      }
