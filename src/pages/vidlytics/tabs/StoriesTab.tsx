...
export default function StoriesTab() {
  ...
  // Mock espelhando o print da listagem
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0094eb]/20 focus:border-[#0094eb] text-sm text-slate-700 bg-slate-50/40"
              />
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div 
                  ...
                  className={`cursor-pointer rounded-xl border-2 p-5 flex flex-col items-center justify-center text-center gap-3 transition-all ${
                    formData.layout === 'flutuante' ? 'border-[#0094eb] bg-sky-50/20' : 'border-slate-100 hover:border-slate-200 bg-white'
                  }`}
                >
                ...
                <div 
                  ...
                  className={`cursor-pointer rounded-xl border-2 p-5 flex flex-col items-center justify-center text-center gap-3 transition-all ${
                    formData.layout === 'carrossel' ? 'border-[#0094eb] bg-sky-50/20' : 'border-slate-100 hover:border-slate-200 bg-white'
                  }`}
                >
                ...
                <div 
                  ...
                  className={`cursor-pointer rounded-xl border-2 p-5 flex flex-col items-center justify-center text-center gap-3 transition-all ${
                    formData.layout === 'grade' ? 'border-[#0094eb] bg-sky-50/20' : 'border-slate-100 hover:border-slate-200 bg-white'
                  }`}
                >
                ...
                <div 
                  ...
                  className={`cursor-pointer rounded-xl border-2 p-5 flex flex-col items-center justify-center text-center gap-2 transition-all ${
                    formData.layout === 'carrossel_dinamico' ? 'border-[#0094eb] bg-sky-50/20' : 'border-slate-100 hover:border-slate-200 bg-white'
                  }`}
                >
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full pl-4 pr-28 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0094eb]/20 focus:border-[#0094eb] text-sm text-slate-700 bg-slate-50/40"
                />
                <button
                  type="button"
  ...
  return (
    <div className="w-full space-y-6 animate-fadeIn pb-12">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        {/* Faixa de Contagem */}
        <div className="bg-slate-50 px-6 py-2.5 border-y border-slate-100">
