...
interface AparenciaModalProps {
  ...
  // Vindos do useAppearanceLogic() via AparenciaTab.tsx
  styleName: string;
  setStyleName: (name: string) => void;
  isDefault: boolean;
  setIsDefault: (value: boolean) => void;
  isUnified: boolean;
  toggleUnified: (checked: boolean) => void;
  formData: any;
      ...
      <div className="bg-white dark:bg-slate-900 w-[95vw] max-w-[1500px] h-[95vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={handleSave} disabled={isSaving || isLoadingStyle} className="flex items-center gap-2 px-6 py-2.5 bg-[#0094eb] text-white rounded-xl text-sm font-bold shadow-md transition-none disabled:opacity-50">
