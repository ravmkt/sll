...
export default function VidlyticsPage() {
  const [activeTab, setActiveTab] = useState<'overview' | 'catalog' | 'stories' | 'appearance' | 'integration'>('overview');
      ...
      {activeTab === 'overview' && (
        <VidlyticsOverviewTab
          ...
          onNavigateTab={(tabKey) => {
            if (tabKey === 'videos') setActiveTab('catalog');
            else if (tabKey === 'stories') setActiveTab('stories');
            else if (tabKey === 'appearance') setActiveTab('appearance');
            else if (tabKey === 'integration') setActiveTab('integration');
          }}
        />
      )}
